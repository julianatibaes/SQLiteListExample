...
public class TShirtsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        */
        ...
        List<TShirt> tShirts = dao.searchTShirt();
        dao.close();
        ...
        listTShirts.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(TShirtsActivity.this, "Camiseta " + shirt.getModelo() + " clicada!", Toast.LENGTH_SHORT).show();

                Intent intent = new Intent(TShirtsActivity.this, NewTShirtActivity.class);
